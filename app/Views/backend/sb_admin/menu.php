            ...
            <li class="nav-item">
                ...
                <div id="collapseA" class="collapse" aria-labelledby="headingA" data-parent="#accordionSidebar">
                    <div class="py-2 bg-white rounded collapse-inner">
                        ...
                        <a class="collapse-item" href="/unidades">Unidades</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseB" class="collapse" aria-labelledby="headingB" data-parent="#accordionSidebar">
                    <div class="py-2 bg-white rounded collapse-inner">
                        <a class="collapse-item" href="/compras/nuevo">Nueva Compra</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseC" class="collapse" aria-labelledby="headingC" data-parent="#accordionSidebar">
                    <div class="py-2 bg-white rounded collapse-inner">
                        ...
                        <a class="collapse-item" href="/cajas">Cajas</a>
                        <a class="collapse-item" href="/logs">Logs de accesos</a>
                        <a class="collapse-item" href="/respaldo">Respaldo</a>
                    </div>
                </div>
            </li>